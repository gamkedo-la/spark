    ...
    static init() {
        this.media = [
            ...
            { src: "img/object1.png", loader: "Sheet", refs: [
                ...
                Templates.xsprite("rope.m",             6, 24, { width: 16*1, height: 16*1 }),
                Templates.xsprite("rail.lr",            7, 24, { width: 16*1, height: 16*2 }),
                Templates.xsprite("rail.t",             8, 24, { width: 16*1, height: 16*2 }),
                ...
                Templates.xsprite("rail.b",             9, 26, { width: 16*1, height: 16*2 }),
        ...
        this.assets = [
            ...
            Templates.tile("02L", "rope.m",             {offy: 0}),
            Templates.tile("02M", "rail.lr",            {offy: -8}),
            Templates.tile("02N", "rail.t",             {offy: -8}),
            Templates.tile("02O", "rail.l",             {offy: -8}),
            Templates.tile("02P", "rail.tr",            {offy: -8}),
            Templates.tile("02Q", "rail.tl",            {offy: -8}),
            Templates.tile("02R", "rail.br",            {offy: -8}),
