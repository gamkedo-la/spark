    ...
    static init() {
        this.media = [
            ...
            { src: "img/inn_lvl1.png", loader: "Sheet", refs: [
                Templates.xsprite("inn.base.tl", 1, 2, {height: 16*3, width: 16*1}),
                Templates.xsprite("inn.base.t", 2, 2, {height: 16*3, width: 16*1} ),
                Templates.xsprite("inn.base.tj", 15, 2, {height: 16*3, width: 16*1}),
                Templates.xsprite("inn.base.tr", 22, 2, {height: 16*3, width: 16*1}),
                Templates.xsprite("inn.base.l", 1, 5, {height: 16*1, width: 16*1} ),
                Templates.xsprite("inn.base.r", 22, 5, {height: 16*1, width: 16*1} ),
                Templates.xsprite("inn.base.entry1", 15, 5, {height: 16*5, width: 16*1}),
                Templates.xsprite("inn.base.bl", 1, 11, {height: 16*3, width: 16*1}),
                Templates.xsprite("inn.base.entry2.l", 7, 11, {height: 16*4, width: 16*1}),
                Templates.xsprite("inn.base.door.b", 8, 13, {height: 16*4, width: 16*2}),
                Templates.xsprite("inn.base.entry2.r", 10, 11, {height: 16*4, width: 16*1}),
                Templates.xsprite("inn.base.room.l", 15, 10, {height: 16*7, width: 16*1}),
                Templates.xsprite("inn.base.entry3", 17, 10, {height: 16*3, width: 16*4}),
                Templates.xsprite("inn.base.room.r", 22, 10, {height: 16*7, width: 16*1}),
                Templates.xsprite("inn.base.tower.tl", 16, 14, {height: 16*3, width: 16*2}),
                Templates.xsprite("inn.base.tower.tr", 20, 14, {height: 16*3, width: 16*2}),
                Templates.xsprite("inn.base.tower.b", 15, 17, {height: 16*6, width: 16*8}),
            ]},
        ...
        this.assets = [
            ...
            Templates.tile("024", "inn.lvl1.tl",        {offx: 0, offy: -16}), //1, 2, {height: 16*3, width: 16*1}),
            Templates.tile("025", "inn.lvl1.t",         {offx: 0, offy: -16}), //2, 2, {height: 16*3, width: 16*1} ),
            Templates.tile("026", "inn.lvl1.tj",        {offx: 0, offy: -16}), //15, 2, {height: 16*3, width: 16*1}),
            Templates.tile("027", "inn.lvl1.tr",        {offx: 0, offy: -16}), //22, 2, {height: 16*3, width: 16*1}),
            Templates.tile("028", "inn.lvl1.l",         {offx: 0, offy: 0}), //1, 5, {height: 16*1, width: 16*1} ),
            Templates.tile("029", "inn.lvl1.r",         {offx: 0, offy: 0}), //22, 5, {height: 16*1, width: 16*1} ),
            Templates.tile("02a", "inn.lvl1.entry1",    {offx: 0, offy: -32}), //15, 5, {height: 16*5, width: 16*1}),
            Templates.tile("02b", "inn.lvl1.bl",        {offx: 0, offy: -16}), //1, 11, {height: 16*3, width: 16*1}),
            Templates.tile("02c", "inn.lvl1.entry2.l",  {offx: 0, offy: -24}), //7, 11, {height: 16*4, width: 16*1}),
            Templates.tile("02d", "inn.lvl1.door.b",    {offx: 8, offy: -24}), //8, 13, {height: 16*4, width: 16*2}),
            Templates.tile("02e", "inn.lvl1.entry2.r",  {offx: 0, offy: -24}), //10, 11, {height: 16*4, width: 16*1}),
            Templates.tile("02f", "inn.lvl1.room.l",    {offx: 0, offy: -48}), //15, 10, {height: 16*7, width: 16*1}),
            Templates.tile("02g", "inn.lvl1.entry3",    {offx: 24, offy: -16}), //17, 10, {height: 16*3, width: 16*4}),
            Templates.tile("02h", "inn.lvl1.room.r",    {offx: 0, offy: -48}), //22, 10, {height: 16*7, width: 16*1}),
            Templates.tile("02i", "inn.lvl1.tower.tl",  {offx: 8, offy: -16}), //16, 14, {height: 16*3, width: 16*2}),
            Templates.tile("02j", "inn.lvl1.tower.tr",  {offx: 8, offy: -16}), //20, 14, {height: 16*3, width: 16*2}),
            Templates.tile("02k", "inn.lvl1.tower.b",   {offx: 56, offy: -40}), //15, 17, {height: 16*6, width: 16*8}),
