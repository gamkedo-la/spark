...
class SparkAssets {
    static init() {
        ...
        this.assets = [
            ...
            Templates.tile("007", "barrel", {xxform: {dx:16}}),
            Templates.tile("008", "halfTable", {xxform: {dx:16}}),
            ...
            Templates.tile("00g", "post.l", { mediaTag: "post", xxform: {dx: -12} }),
            Templates.tile("00h", "post.r", { mediaTag: "post", xxform: {dx: 10} }),
            Templates.tile("00i", "post.s"),
            Templates.tile("00j", "post.sr", { mediaTag: "post.s", xxform: {dx:16} }),
            Templates.tile("00k", "vendorBench"),
            Templates.tile("00l", "postUpper.l", { xxform: {dx:16} }),
            Templates.tile("00m", "postUpper.s", { xxform: {dx:16} }),
            Templates.tile("00n", "postUpper.r", { xxform: {dx:16} }),
