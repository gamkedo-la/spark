    ...
    static init() {
        this.media = [
            ...
            { src: "img/inn_base.png", loader: "Sheet", refs: [
                ...
                Templates.varSpriteRef("inn.base.t", [[2,4], [3,4], [4,4]], {height: 16*3, width: 16*1} ),
                Templates.xsprite("inn.base.tj", 15, 4, {height: 16*3, width: 16*1}),
                Templates.xsprite("inn.base.tr", 22, 4, {height: 16*3, width: 16*1}),
                Templates.varSpriteRef("inn.base.lr", [[1,7], [1,8], [1,9], [1,10]], {height: 16*1, width: 16*1} ),
                Templates.xsprite("inn.base.entry1", 15, 6, {height: 16*6, width: 16*1}),
                ...
                Templates.xsprite("inn.base.room.l", 15, 12, {height: 16*7, width: 16*1}),
                Templates.xsprite("inn.base.entry3", 17, 12, {height: 16*4, width: 16*4}),
                Templates.xsprite("inn.base.room.r", 22, 12, {height: 16*7, width: 16*1}),
        ...
        this.assets = [
            ...
            Templates.tile("01M", "inn.base.tl", {offx: 0, offy: -16}), //1, 6, {height: 16*3, width: 16*1}),
            Templates.tile("01N", "inn.base.t", {offx: 0, offy: -16}), //[[2,6], [3,6], [4,6]], {height: 16*3, width: 16*1} ),
            Templates.tile("01O", "inn.base.tj", {offx: 0, offy: -16}), //15, 6, {height: 16*3, width: 16*1}),
            Templates.tile("01P", "inn.base.tr", {offx: 0, offy: -16}), //22, 6, {height: 16*3, width: 16*1}),
            Templates.tile("01Q", "inn.base.lr", {offx: 0, offy: 0}), //[[2,7], [2,8], [2,9], [2,10]], {height: 16*1, width: 16*1} ),
            Templates.tile("01R", "inn.base.entry1", {offx: 0, offy: -40}), //15, 12, {height: 16*6, width: 16*1}),
            ...
            Templates.tile("01Y", "inn.base.room.l", {offx: 0, offy: -48}), //15, 18, {height: 16*7, width: 16*1}),
            Templates.tile("01Z", "inn.base.entry3", {offx: 24, offy: -24}), //17, 15, {height: 16*4, width: 16*4}),
            Templates.tile("020", "inn.base.room.r", {offx: 0, offy: -48}), //22, 18, {height: 16*7, width: 16*1}),
            Templates.tile("021", "inn.base.tower.tl", {offx: 8, offy: -16}), //16, 18, {height: 16*3, width: 16*2}),
            Templates.tile("022", "inn.base.tower.tr", {offx: 8, offy: -16}), //20, 18, {height: 16*3, width: 16*2}),
            Templates.tile("023", "inn.base.tower.b", {offx: 56, offy: -40}), //15, 24, {height: 16*6, width: 16*8}),
