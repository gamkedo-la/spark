...
class UxSlider2Knob extends UxPanel {
    cpost(spec={}) {
        super.cpost(spec);
    }
}

class UxSlider2 extends UxView {
    // STATIC VARIABLES ----------------------------------------------------
    static dfltBar = {
        cls: "Rect",
    ...
    cpost(spec={}) {
        ...
        let xknobView = {
            ...
            xsketch: spec.xknob || UxSlider2.dfltKnob,
        }
        this.knobView = new UxSlider2Knob(xknobView);
        ...
        if (this.dragging) {
            if (Mouse.down) {
                ...
                if (value !== this._value) {
                    this.value = value;
                    Base.instance.audioMgr.musicVol = this._value;
                }
            } else {
                this.dragging = false;
            }
